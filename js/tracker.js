  ...
  function handleReviewButtonClick() {
    document.querySelectorAll('.write-review-btn').forEach(button => {
      button.addEventListener('click', function() {
        ...
        window.location.href = 'write-a-review.html';
      });
    });
  }
  ...
  function handleOrderButtonClick() {
    document.querySelectorAll('.view-order-btn').forEach(button => {
      button.addEventListener('click', function() {
        ...
        window.location.href = `order_details.html?product=${productId}&category=${productCategory}`;
      });
    });
  }
...
function viewOrder(status) {
  window.location.href = `order.html?status=${status}`;
}
// ########## END TRACKER JS ############### //
